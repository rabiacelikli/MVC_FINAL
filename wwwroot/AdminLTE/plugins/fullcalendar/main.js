    ...
    */
    var AutoScroller = /** @class */ (function () {
        function AutoScroller() {
            ...
            this.maxVeloPhotoFile = 300; // pixels per second
            // internal state
        ...
        AutoScroller.prototype.handleSide = function (edge, seconds) {
            ...
            var veloPhotoFile = // the closer to the edge, the faster we scroll
             ((invDistance * invDistance) / (edgeThreshold * edgeThreshold)) * // quadratic
                this.maxVeloPhotoFile * seconds;
            var sign = 1;
            switch (edge.name) {
                case 'left':
                    sign = -1;
                // falls through
                case 'right':
                    scrollCache.setScrollLeft(scrollCache.getScrollLeft() + veloPhotoFile * sign);
                    break;
                case 'top':
                    sign = -1;
                // falls through
                case 'bottom':
                    scrollCache.setScrollTop(scrollCache.getScrollTop() + veloPhotoFile * sign);
                    break;
            }
        };
